...
import (
	...
	clients "github.com/absmach/supermq/pkg/clients"

	mock "github.com/stretchr/testify/mock"

	roles "github.com/absmach/supermq/pkg/roles"

	things "github.com/absmach/supermq/things"
)
...
func (_m *Repository) AddConnections(ctx context.Context, conns []things.Connection) error {
...
func (_m *Repository) RemoveConnections(ctx context.Context, conns []things.Connection) error {
	ret := _m.Called(ctx, conns)
...
// RemoveThings provides a mock function with given fields: ctx, clientIDs
func (_m *Repository) RemoveThings(ctx context.Context, clientIDs ...[]string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for RemoveThings")
	}
