...
'data/localhost.crt' -> '~/Documents/supermq/docker/ssl/certs/magistrala-server.crt'
'data/localhost.key' -> '~/Documents/supermq/docker/ssl/certs/magistrala-server.key'
